...
public extension NSView {
    ...
    /// - Parameter color: You can use `NSColor.colorName.cgColor` to pass NSColor value
    @discardableResult
    ...
    /// Change layer's background color
    @discardableResult
    func layer(backgroundColor color: NSColor?) -> Self {
    ...
    /// - Parameter color: use `NSColor.colorName.cgColor` to pass NSColor value.
    @discardableResult
    ...
    /// Change layer's border color.
    @discardableResult
    func layer(borderColor: NSColor?) -> Self {
    ...
    /// - Parameter color: Pass `NSColor.colorName.cgColor` to pass NSColor value
    @discardableResult
    ...
    /// Change layer's shadow color.
    @discardableResult
    func layer(shadowColor: NSColor?) -> Self {
